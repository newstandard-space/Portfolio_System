    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Work新規登録ページ</li>
            </ol>
        </nav>
        ...
        <ul class="nav nav-tabs mb-3 mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('admin.work.create.images')}}" tabindex="-1" aria-disabled="true">画像情報</a>
            </li>
        </ul>
